...
tk.Button(root, text="Rekam Wajah", command=record_face).pack(pady=10)
tk.Button(root, text="Absensi", command=mark_attendance).pack(pady=10)
tk.Button(root, text="Laporan Kehadiran", command=view_report).pack(pady=10)
